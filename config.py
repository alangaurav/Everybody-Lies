...
SQLALCHEMY_DATABASE_URI='postgresql://epsilon:racingiscool@localhost:5432/eldb'    #'mysql+pymysql://epsilon:housemd@localhost/app_db' #sqlite:///'+os.path.join(basedir,'test.db')
